...
A still of the frame under a row on which a value — a zoom's region, an overlay's rectangle, a crop, a text block, a redaction region, a spotlight region — is dragged into place instead of typed. See [Visual editors](visual-editors.md).
